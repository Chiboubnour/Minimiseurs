...
int main() {
    std::cout << "=====================================\n";
    std::cout << "  Test CPU : Minimizer Hash (omp)\n";
    std::cout << "=====================================\n";
    
    int max_threads = omp_get_max_threads();
    std::cout << "Nombre de threads matériels disponibles : " << max_threads << std::endl;
    ...
    #pragma omp parallel
    {
        if (omp_get_thread_num() == 0) {
            std::cout << "Nombre de threads utilisés : " 
    ...
    uint64_t nElements = (256ull * 1024 * 1024) / sizeof(uint64_t);
